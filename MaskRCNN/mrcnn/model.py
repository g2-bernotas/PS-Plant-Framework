...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_{}.h5".format(
           self.config.NAME.lower()))
        # if self.config.crop == "no":
        #     if self.config.hyponasty == "hyponasty":
        #         if self.config.mode == "scratch":
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{} ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #         else:
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{} ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #     else:
        #         if self.config.mode == "scratch":
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}NoHyponasty ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #         else:
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}NoHyponasty ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        ...
        #     if self.config.hyponasty == "hyponasty":
        #         if self.config.mode == "scratch":
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}Cropped ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #         else:
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}Cropped ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #     else:
        #         if self.config.mode == "scratch":
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}NoHyponastyCropped ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
        #         else:
        #             self.checkpoint_path = os.path.join(self.log_dir, "NLNT{}NoHyponastyCropped ({}).h5".format(
        #                 self.config.type.lower(), self.config.mode.lower()))
